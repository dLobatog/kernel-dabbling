cmd_arch/x86/entry/vdso/vdso.lds := gcc -E -Wp,-MD,arch/x86/entry/vdso/.vdso.lds.d  -nostdinc -isystem /usr/lib/gcc/x86_64-redhat-linux/6.1.1/include -I/home/daniel/workspace/kernel-dabbling/teeny-linux/linux/arch/x86/include -I./arch/x86/include/generated/uapi -I./arch/x86/include/generated  -I/home/daniel/workspace/kernel-dabbling/teeny-linux/linux/include -I./include -I/home/daniel/workspace/kernel-dabbling/teeny-linux/linux/arch/x86/include/uapi -I/home/daniel/workspace/kernel-dabbling/teeny-linux/linux/include/uapi -I./include/generated/uapi -include /home/daniel/workspace/kernel-dabbling/teeny-linux/linux/include/linux/kconfig.h -D__KERNEL__ -P -C -P -C -Ux86 -D__ASSEMBLY__ -DLINKER_SCRIPT -o arch/x86/entry/vdso/vdso.lds /home/daniel/workspace/kernel-dabbling/teeny-linux/linux/arch/x86/entry/vdso/vdso.lds.S

source_arch/x86/entry/vdso/vdso.lds := /home/daniel/workspace/kernel-dabbling/teeny-linux/linux/arch/x86/entry/vdso/vdso.lds.S

deps_arch/x86/entry/vdso/vdso.lds := \
  /home/daniel/workspace/kernel-dabbling/teeny-linux/linux/arch/x86/entry/vdso/vdso-layout.lds.S \
